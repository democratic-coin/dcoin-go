...
// Open new Connection.
// See https://github.com/c-darwin/dcoin-go/vendor/src/github.com/go-sql-driver/mysql#dsn-data-source-name for how
...
func handleAuthResult(mc *mysqlConn, cipher []byte) error {
	...
	if mc.cfg.allowOldPasswords && err == ErrOldPassword {
		...
		// https://github.com/c-darwin/dcoin-go/vendor/src/github.com/go-sql-driver/mysql/issues/184
