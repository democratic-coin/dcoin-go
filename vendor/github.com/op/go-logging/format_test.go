...
func TestFormatFuncName(t *testing.T) {
	var tests = []struct {
		...
		{"main.main",
			...
			"main",
			"main"},
		{"github.com/c-darwin/dcoin-go/vendor/src/github.com/op/go-logging.func·001",
			"github.com/c-darwin/dcoin-go/vendor/src/github.com/op/go-logging",
			"go-logging",
			"func·001",
			"func·001"},
		{"github.com/c-darwin/dcoin-go/vendor/src/github.com/op/go-logging.stringFormatter.Format",
			"github.com/c-darwin/dcoin-go/vendor/src/github.com/op/go-logging",
			"go-logging",
