go-version [![Build Status](https://travis-ci.org/mcuadros/go-version.png?branch=master)](https://travis-ci.org/mcuadros/go-version) [![GoDoc](https://godoc.org/github.com/c-darwin/dcoin-go/vendor/src/github.com/mcuadros/go-version?status.png)](http://godoc.org/github.com/c-darwin/dcoin-go/vendor/src/github.com/mcuadros/go-version)
==============================
...
```
go get github.com/c-darwin/dcoin-go/vendor/src/github.com/mcuadros/go-version
```
