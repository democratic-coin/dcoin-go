...
На биржах <a href="https://github.com/democratic-coin/dcoin-go/wiki/Биржи">https://github.com/democratic-coin/dcoin-go/wiki/Биржи</a> Вы в любой момент можете продать dUSD или отправить запрос на обмен другому майнеру.
</p>
{{end}}
